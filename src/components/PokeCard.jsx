...
export default function PokeCard (props) {
    ...
    const { name, types, height, abilities, stats, moves, sprites} = data || {}
    ...
    useEffect(() => {
        ...
        // 2. check if the selected pokemon is in the cache, otherwise fetch the api
        ...
        // we passed all the cache stuff to no avail and now we need to fetch data from the api
